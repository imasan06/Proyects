...
const defenseTips = [
  ...
  "Give space to fast players.",
  "Communicate with teammates.",
  "Guide, don’t reach.",
  "Force weak hand.",
  "Slide, don’t cross feet.",
  "Arms up on contests.",
  "Know team defense.",
  "Use quick footwork.",
  "Recover fast.",
  "Be aware of weak-side."
];

const defenseChallenges = [
  "Guard for 24 seconds without a score.",
  "Perform 5 perfect closeouts.",
  "Force 3 turnovers in 1v1.",
  "Hold a stance for 3 minutes.",
  "Contest 10 shots without fouling.",
  "Get 5 deflections.",
  "Do 10 defensive slides.",
  "Stop 3 drives in 1v1.",
  "Force 5 pickups in a scrimmage.",
  "Win 5 straight 1v1 possessions.",
  "Stay in front of a fast player for 5 sec.",
  "Deflect 3 passes in 3 minutes.",
  "Deny 5 entry passes.",
  "Defend 5 pick-and-roll plays.",
  "Recover and secure 10 rebounds.",
  "Force 10 weak-hand dribbles.",
  "Contest 5 shots with verticality.",
  "Complete 5 help rotations.",
  "Win 3 full-court 1v1 stops.",
  "Shuffle full court without stopping.",
  "Get 2 consecutive defensive stops.",
  "Avoid 5 pump fakes in a game.",
  "Trap successfully 3 times.",
  "Recover from screens 5 times.",
  "Do 10 perfect slides without cones.",
  "Block 3 shots without fouling.",
  "Secure 5 rebounds vs. taller players.",
  "Defend isolation for 10 seconds.",
  "Force 3 bad shots in game drill.",
  "Win 3 transition defense plays.",
];

export const Tipgenerator2 = () => {
  ...
  useEffect(() => {
    ...
    if (!last || now - last >= 86400000) {
      const next = (currentChallenge + 1) % defenseChallenges.length;
  ...
  useEffect(() => {
    const tipInterval = setInterval(() => {
      setCurrentTip((prevTip) => (prevTip + 1) % defenseTips.length);
      ...
      <Card className="bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900">
        <CardHeader>
          <CardTitle className="flex items-center">
            <Lightbulb className="mr-2 h-5 w-5" /> Defense Tip
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-xl italic">{defenseTips[currentTip]}</p>
          <section className="pt-5 items-center ">
            ...
            <div className=" flex items-center w-full space-x-10 my-2 border-y-[#8D8D8D] border-b-[1px] py-2">
              ...
              <h2 className="text-sm font-regular">
                {defenseChallenges[currentChallenge]}
              </h2>
