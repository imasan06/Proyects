...
const exercises = [
    {
      ...
      drills: [
        ...
        {
          title: "High Knees",
          description: "2x30 sec - Increases explosiveness and coordination.",
        },
        {
          title: "Lateral Quick Steps",
          description: "3x30 sec - Enhances lateral speed for better movement.",
        },
        {
          title: "Wrist Mobility Drills",
          description: "2 min - Prepares hands for smooth dribbling transitions.",
        },
      ],
    },
  ];
  ...
  const exercises2 = [
    {
      title: "Fundamental Drills (15 min) - Ball Control",
      description: "15 min",
      drills: [
        {
          title: "Pound Dribbles (Right & Left Hand)",
          description: "3x30 sec - Strengthens hand control and dribbling confidence.",
        },
        {
          title: "Low Dribble Control",
          description: "3x30 sec - Dribble as low as possible to improve handling under pressure.",
        },
        {
          title: "Side-to-Side Crossovers",
          description: "3x30 sec - Smooth side crossovers to develop control.",
        },
        {
          title: "Stationary Tight Crossovers",
          description: "3x30 sec - Quick, tight crossovers without moving.",
        },
      ],
    },
  ];
  ...
  const exercises3 = [
    {
      title: "Game-Like Drills (15 min) - Speed & Reaction",
      description: "15 min",
      drills: [
        {
          title: "Cone Crossovers",
          description: "3x10 reps - Cross over at each cone while advancing.",
        },
        {
          title: "1-on-1 Crossover Attack",
          description: "4x30 sec - Perform crossovers and drive past a defender.",
        },
        {
          title: "Speed Crossovers into Sprint",
          description: "3x10 reps - Quick crossover followed by an explosive sprint.",
        },
        {
          title: "Reaction Crossovers",
          description: "3x30 sec - React to a partner’s movement before crossing over.",
        },
      ],
    },
  ];
  ...
  const exercises4 = [
    {
      title: "Cool Down (5 min) - Recovery & Stretching",
      description: "5 min",
      drills: [
        {
          title: "Slow Dribbling Control",
          description: "2 min - Dribble at a slow pace to reinforce technique.",
        },
        {
          title: "Hamstring & Hip Flexor Stretch",
          description: "1 min - Stretch the lower body for better mobility.",
        },
        {
          title: "Deep Breathing & Relaxation",
          description: "2 min - Helps recover and mentally reset.",
        },
      ],
    },
  ];
