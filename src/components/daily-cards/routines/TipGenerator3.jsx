...
const crossoverTips = [
  "Stay low for control and explosiveness.",
  "Keep your head up to read defenders.",
  "Use your off-hand to shield the ball.",
  "Dribble with fingertips, not your palm.",
  "Sell fakes with your body, not just the ball.",
  "Vary speed to keep defenders guessing.",
  "Practice at game speed for realism.",
  "Ensure smooth transitions between dribbles.",
  "Train both hands for unpredictability.",
  "Engage your core for balance.",
  "Use eye fakes to deceive defenders.",
  "Add hesitation for more effectiveness.",
  "Time your crossover based on defense.",
  "Use quick dribbles before exploding.",
  "Combine crossovers with other moves."
];

const crossoverChallenges = [
  "Do 50 crossovers without losing control.",
  "Perform 10 ankle-breaker crossovers in 1v1.",
  "Execute 5 crossovers into a jump shot.",
  "Break a defender’s stance 3 times in a game.",
  "Do 100 crossovers in under 1 minute.",
  "Use a crossover to beat a defender 5 times.",
  "Complete 10 killer crossovers in a row.",
  "Perform 5 crossovers into a layup.",
  "Do 3 straight crossovers without traveling.",
  "Win 5 1v1 possessions using a crossover.",
  "Perform 10 between-the-legs crossovers.",
  "Land 5 step-back shots after a crossover.",
  "Chain 3 different crossover moves in a play.",
  "Do a crossover into a spin move 5 times.",
  "Execute a double crossover on a defender.",
  "Perform 5 behind-the-back crossovers.",
  "Break full-court press with a crossover.",
  "Use a crossover to avoid a trap 3 times.",
  "Perform 20 quick crossovers in a row.",
  "Beat a defender with a crossover and score."
];


  

  export const Tipgenerator3 = () => {
    ...
    useEffect(() => {
      ...
      if (!last || now - last >= 86400000) {
        const next = (currentChallenge + 1) % crossoverChallenges.length;
    ...
    useEffect(() => {
      const tipInterval = setInterval(() => {
        setCurrentTip((prevTip) => (prevTip + 1) % crossoverTips.length)
        ...
        <Card className="bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900">
          <CardHeader>
            <CardTitle className="flex items-center">
              <Lightbulb className="mr-2 h-5 w-5" /> Crossover Tip
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-xl italic">{crossoverTips[currentTip]}</p>
            ...
            <div className=" flex items-center w-full space-x-10 my-2 border-y-[#8D8D8D] border-b-[1px] py-2">
              ...
              <h2 className="text-sm font-regular">
                {crossoverChallenges[currentChallenge]}
              </h2>
